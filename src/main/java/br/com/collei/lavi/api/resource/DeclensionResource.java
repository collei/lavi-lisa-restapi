...
public class DeclensionResource {
    ...
    @APIResponses(value = {
        @APIResponse(responseCode = "200", description = "Verbo com sua tabela de conjugação.", content = @Content(schema = @Schema(implementation = ResponseNounDeclensionTableData.class))),
		...
		@APIResponse(responseCode = "200", description = "Tabela de conjugação do verbo especificado", content = @Content(schema = @Schema(implementation = ResponseNounDeclensionTableData.class)))
    })
	public Response declinar(@PathParam("noun") String noun) {
		System.out.println("\r\n--- Substantivo: '" + noun + "'\r\n");
